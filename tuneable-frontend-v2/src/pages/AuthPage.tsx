  ...
  const renderLoginForm = () => (
    <div className="p-5">
      ...
      <div className="mt-7 flex items-center justify-center flex-col gap-2">
        <button onClick={() => handleSocialAuth('google')} type="button" className="py-2 px-4 mr-6 w-auto max-w-md flex justify-center items-center bg-red-600 hover:bg-red-700 focus:ring-red-500 focus:ring-offset-red-200 text-gray transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg">
