            ...
            {!showTopFansPanel ? (
              <div className="flex justify-center">
                <button
                  ...
                  className="px-4 py-2 rounded-lg bg-transparent hover:bg-gray-700/20 text-gray-200 font-medium transition-colors text-sm sm:text-base flex items-center gap-2"
                >
