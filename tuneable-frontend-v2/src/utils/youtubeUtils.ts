 ...
 * @param quality - Thumbnail quality: 'default', 'medium', 'high', 'hqdefault', 'maxresdefault'
 * @returns Thumbnail URL or null if videoId is invalid
 */
export function getYouTubeThumbnail(videoId: string | null | undefined, quality: 'default' | 'medium' | 'high' | 'hqdefault' | 'maxresdefault' = 'hqdefault'): string | null {
 ...
 */
export function getYouTubeThumbnailFromUrl(url: string | null | undefined, quality: 'default' | 'medium' | 'high' | 'hqdefault' | 'maxresdefault' = 'hqdefault'): string | null {
