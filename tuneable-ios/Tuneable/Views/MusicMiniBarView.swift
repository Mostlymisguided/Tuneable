...
struct MusicMiniBarView: View {
    ...
    private var progressBar: some View {
        GeometryReader { geo in
            ...
            let progress = width > 0 && musicPlayer.duration > 0
                ? min(1, max(0, musicPlayer.currentTime / musicPlayer.duration))
                : 0.0
    ...
    private func coverImage(item: GlobalPartyMediaItem) -> some View {
